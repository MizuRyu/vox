...
- **よく間違う語は辞書で直せる。** 「認識される表記」と「入れたい表記」を 1 行ずつ登録すると、貼り付ける本文で置き換えます。
...
設定画面はメニューバーの「設定…」、HUD の歯車、`⌘,` のいずれかで開きます。録音とファイル検索のショートカット、自動Enter、使用するマイク、通話向けの音声処理（実験的）を変更でき、辞書もここの表で追加・編集できます。
